...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-DpxrvkA5.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-nBc894pq.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-LqwnbO6z.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-zcNRuA7Q.js"), "./pages/auth/Login.vue": () => import("./assets/Login-BOrmb-ra.js"), "./pages/auth/Register.vue": () => import("./assets/Register-Ci_0M4AB.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-CcZnEPn5.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-Cx3DaDeO.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-CUA7BaRt.js"), "./pages/settings/Password.vue": () => import("./assets/Password-BHLdlzyA.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-BmCWoyFt.js") })),
